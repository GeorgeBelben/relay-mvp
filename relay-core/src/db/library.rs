...
/// are forward-slash-relative to the media root -- resolving either into something an `<img>` can
/// load is a frontend-loading decision (asset-protocol scope vs. a byte-serving command), not this
/// module's job. Ported from the Electron MVP's
