...
// --- Typed general settings, ported from the Electron MVP's electron-store schema
...
// ad-hoc fallback logic across call sites.
...
// Relay's own product defaults, not inherited from RetroArch's own config.def.h defaults --
// video_smooth/video_scale_integer/run_ahead_enabled are genuine product choices for this
// console, independent of whatever upstream RetroArch happens to default to.
