...
// timedatectl call sites that used to live directly in commands/{network,bluetooth,datetime}.rs.
// No logic changed, only moved: the parsing/classification code these wrap stays in
// system::{network,bluetooth,datetime} untouched.
